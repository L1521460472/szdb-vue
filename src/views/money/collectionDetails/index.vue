 ...
 * @LastEditTime: 2024-01-15 15:38:28
-->
<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tableData">
      ...
      <el-table-column label="回款日期" align="center" prop="collectionTime" />
      <el-table-column label="创建日期" align="center" min-width="130" prop="createTime" />
      <el-table-column label="附件" align="center" prop="fileUrl">
        <!-- <template #default="scope">
          <el-image style="width: 100px; height: 50px" :src="scope.row.fileUrl" :preview-src-list="[scope.row.fileUrl]" preview-teleported/>
        </template> -->
        <template #default="scope">
    ...
    >
      <el-form ref="collectionRef" :model="formInfo.data" :rules="formInfo.rules" label-width="90px">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="附件" class="fileUpload">
              <el-upload
                ref="uploadRef"
